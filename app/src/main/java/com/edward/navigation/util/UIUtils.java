...
public class UIUtils {
    ...
    public static void GetInfo(Context context) {
        ...
        //Log.d("rong", "screenWidth=" + screenWidth + " screenHeight=" + screenHeight + " density=" + density);
    ...
    public static void setShakeAnimation(View view,int count) {
        view.startAnimation(shakeAnimation(count));
    }
    /**
     * 晃动动画
